...
define( 'FPPG_WALLERIBOXLITE_VERSION', '1.3.4' );
...
function fppg_admin_head() {
	...
	wp_enqueue_script('walleriboxliteadmin',FACEBOOK_PAGE_URL . '/walleriboxlite/admin.js', array('jquery')); // Load specific JS for Admin Page
}
...
if(!is_admin()){
  //wp_deregister_script('jquery');
       ...
       //register
       wp_register_script('easing', FACEBOOK_PAGE_URL.'/walleriboxlite/jquery.easing-'.FPPG_EASING_VERSION.'.pack.js', array('jquery'), FPPG_EASING_VERSION);
       //enqueue
       wp_enqueue_script('easing');
       //deregister mousewheel
       wp_deregister_script('mousewheel');
       //re-register
       wp_register_script('mousewheel', FACEBOOK_PAGE_URL.'/walleriboxlite/jquery.mousewheel-'.FPPG_MOUSEWHEEL_VERSION.'.pack.js', array('jquery'), FPPG_MOUSEWHEEL_VERSION);
       //enqueue
       wp_enqueue_script('mousewheel');
       //deregister any walleriboxlite
       wp_deregister_script('walleriboxlite');
       //register walleriboxlite
       wp_register_script('walleriboxlite',FACEBOOK_PAGE_URL.'/walleriboxlite/jquery.walleriboxlite-'.FPPG_WALLERIBOXLITE_VERSION.'.pack.js', array('jquery'), FPPG_WALLERIBOXLITE_VERSION);
       //enqueue for use
       wp_enqueue_script('walleriboxlite');
...
wp_deregister_style('walleriboxlite');
wp_register_style('walleriboxlite', FACEBOOK_PAGE_URL.'/fppg-walleriboxlite.css.php', false, FPPG_WALLERIBOXLITE_VERSION, 'screen');
wp_enqueue_style('walleriboxlite');
}
}
...
add_action('wp_head', 'do_walleriboxlite');
